...
llvm::StructType* RuntimeManager::getTxContextType()
{
	...
	return llvm::StructType::create({Type::Word, Type::Address, Type::Address, i64, i64, i64, Type::Word}, name);
}
...
llvm::Value* RuntimeManager::getTxContextItem(unsigned _index)
{
	...
	{
		// NOTE: no longer needed, as addresses are now represented as 32 bytes
...
llvm::Value* RuntimeManager::getCaller()
{
