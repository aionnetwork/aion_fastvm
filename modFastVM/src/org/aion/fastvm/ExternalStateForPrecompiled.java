...
/**
 * A TEMPORARY implementation of the {@link IExternalStateForPrecompiled} interface!
 *
 * Once internal precompiled contract calls are moved out into the kernel interface, this will go
 * away.
 */
public final class ExternalStateForPrecompiled implements IExternalStateForPrecompiled {
    ...
    public ExternalStateForPrecompiled(RepositoryCache<AccountState, IBlockStoreBase> repository, long blockNumber, boolean isLocalCall, boolean allowNonceIncrement) {
        if (repository == null) {
            throw new NullPointerException("Cannot create precompiled world state with null repository!");
        }
