...
const std::map<std::string, Instruction> dev::solidity::c_instructions =
{
	...
	{ "SWAP17", Instruction::SWAP17 },
	{ "SWAP18", Instruction::SWAP18 },
	{ "SWAP19", Instruction::SWAP19 },
	{ "SWAP20", Instruction::SWAP20 },
	{ "SWAP21", Instruction::SWAP21 },
	{ "SWAP22", Instruction::SWAP22 },
	{ "SWAP23", Instruction::SWAP23 },
	{ "SWAP24", Instruction::SWAP24 },
	{ "SWAP25", Instruction::SWAP25 },
	{ "SWAP26", Instruction::SWAP26 },
	{ "SWAP27", Instruction::SWAP27 },
	{ "SWAP28", Instruction::SWAP28 },
	{ "SWAP29", Instruction::SWAP29 },
	{ "SWAP30", Instruction::SWAP30 },
	{ "SWAP31", Instruction::SWAP31 },
	{ "SWAP32", Instruction::SWAP32 },
...
{ //												Add, Args, Ret, SideEffects, GasPriceTier
	...
	{ Instruction::KECCAK256,	{ "KECCAK256",			0, 2, 2, false, Tier::Special } },
	{ Instruction::ADDRESS,		{ "ADDRESS",		0, 0, 2, false, Tier::Base } },
	{ Instruction::BALANCE,		{ "BALANCE",		0, 2, 1, false, Tier::Balance } },
	{ Instruction::ORIGIN,		{ "ORIGIN",			0, 0, 2, false, Tier::Base } },
	{ Instruction::CALLER,		{ "CALLER",			0, 0, 2, false, Tier::Base } },
	...
	{ Instruction::EXTCODESIZE,	{ "EXTCODESIZE",	0, 2, 1, false, Tier::ExtCode } },
	{ Instruction::EXTCODECOPY,	{ "EXTCODECOPY",	0, 5, 0, true, Tier::ExtCode } },
	...
	{ Instruction::BLOCKHASH,	{ "BLOCKHASH",		0, 1, 2, false, Tier::Ext } },
	{ Instruction::COINBASE,	{ "COINBASE",		0, 0, 2, false, Tier::Base } },
	...
	{ Instruction::PUSH17,		{ "PUSH17",			17, 0, 2, false, Tier::VeryLow } },
	{ Instruction::PUSH18,		{ "PUSH18",			18, 0, 2, false, Tier::VeryLow } },
	{ Instruction::PUSH19,		{ "PUSH19",			19, 0, 2, false, Tier::VeryLow } },
	{ Instruction::PUSH20,		{ "PUSH20",			20, 0, 2, false, Tier::VeryLow } },
	{ Instruction::PUSH21,		{ "PUSH21",			21, 0, 2, false, Tier::VeryLow } },
	{ Instruction::PUSH22,		{ "PUSH22",			22, 0, 2, false, Tier::VeryLow } },
	{ Instruction::PUSH23,		{ "PUSH23",			23, 0, 2, false, Tier::VeryLow } },
	{ Instruction::PUSH24,		{ "PUSH24",			24, 0, 2, false, Tier::VeryLow } },
	{ Instruction::PUSH25,		{ "PUSH25",			25, 0, 2, false, Tier::VeryLow } },
	{ Instruction::PUSH26,		{ "PUSH26",			26, 0, 2, false, Tier::VeryLow } },
	{ Instruction::PUSH27,		{ "PUSH27",			27, 0, 2, false, Tier::VeryLow } },
	{ Instruction::PUSH28,		{ "PUSH28",			28, 0, 2, false, Tier::VeryLow } },
	{ Instruction::PUSH29,		{ "PUSH29",			29, 0, 2, false, Tier::VeryLow } },
	{ Instruction::PUSH30,		{ "PUSH30",			30, 0, 2, false, Tier::VeryLow } },
	{ Instruction::PUSH31,		{ "PUSH31",			31, 0, 2, false, Tier::VeryLow } },
	{ Instruction::PUSH32,		{ "PUSH32",			32, 0, 2, false, Tier::VeryLow } },
	...
	{ Instruction::DUP17,		{ "DUP17",			0, 17, 18, false, Tier::VeryLow } },
	{ Instruction::DUP18,		{ "DUP18",			0, 18, 19, false, Tier::VeryLow } },
	{ Instruction::DUP19,		{ "DUP19",			0, 19, 20, false, Tier::VeryLow } },
	{ Instruction::DUP20,		{ "DUP20",			0, 20, 21, false, Tier::VeryLow } },
	{ Instruction::DUP21,		{ "DUP21",			0, 21, 22, false, Tier::VeryLow } },
	{ Instruction::DUP22,		{ "DUP22",			0, 22, 23, false, Tier::VeryLow } },
	{ Instruction::DUP23,		{ "DUP23",			0, 23, 24, false, Tier::VeryLow } },
	{ Instruction::DUP24,		{ "DUP24",			0, 24, 25, false, Tier::VeryLow } },
	{ Instruction::DUP25,		{ "DUP25",			0, 25, 26, false, Tier::VeryLow } },
	{ Instruction::DUP26,		{ "DUP26",			0, 26, 27, false, Tier::VeryLow } },
	{ Instruction::DUP27,		{ "DUP27",			0, 27, 28, false, Tier::VeryLow } },
	{ Instruction::DUP28,		{ "DUP28",			0, 28, 29, false, Tier::VeryLow } },
	{ Instruction::DUP29,		{ "DUP29",			0, 29, 30, false, Tier::VeryLow } },
	{ Instruction::DUP30,		{ "DUP30",			0, 30, 31, false, Tier::VeryLow } },
	{ Instruction::DUP31,		{ "DUP31",			0, 31, 32, false, Tier::VeryLow } },
	{ Instruction::DUP32,		{ "DUP32",			0, 32, 33, false, Tier::VeryLow } },
	...
	{ Instruction::SWAP17,		{ "SWAP17",			0, 18, 18, false, Tier::VeryLow } },
	{ Instruction::SWAP18,		{ "SWAP18",			0, 19, 19, false, Tier::VeryLow } },
	{ Instruction::SWAP19,		{ "SWAP19",			0, 20, 20, false, Tier::VeryLow } },
	{ Instruction::SWAP20,		{ "SWAP20",			0, 21, 21, false, Tier::VeryLow } },
	{ Instruction::SWAP21,		{ "SWAP21",			0, 22, 22, false, Tier::VeryLow } },
	{ Instruction::SWAP22,		{ "SWAP22",			0, 23, 23, false, Tier::VeryLow } },
	{ Instruction::SWAP23,		{ "SWAP23",			0, 24, 24, false, Tier::VeryLow } },
	{ Instruction::SWAP24,		{ "SWAP24",			0, 25, 25, false, Tier::VeryLow } },
	{ Instruction::SWAP25,		{ "SWAP25",			0, 26, 26, false, Tier::VeryLow } },
	{ Instruction::SWAP26,		{ "SWAP26",			0, 27, 27, false, Tier::VeryLow } },
	{ Instruction::SWAP27,		{ "SWAP27",			0, 28, 28, false, Tier::VeryLow } },
	{ Instruction::SWAP28,		{ "SWAP28",			0, 29, 29, false, Tier::VeryLow } },
	{ Instruction::SWAP29,		{ "SWAP29",			0, 30, 30, false, Tier::VeryLow } },
	{ Instruction::SWAP30,		{ "SWAP30",			0, 31, 31, false, Tier::VeryLow } },
	{ Instruction::SWAP31,		{ "SWAP31",			0, 32, 32, false, Tier::VeryLow } },
	{ Instruction::SWAP32,		{ "SWAP32",			0, 33, 33, false, Tier::VeryLow } },
	{ Instruction::LOG0,		{ "LOG0",			0, 2, 0, true, Tier::Special } },
	{ Instruction::LOG1,		{ "LOG1",			0, 4, 0, true, Tier::Special } },
	{ Instruction::LOG2,		{ "LOG2",			0, 6, 0, true, Tier::Special } },
	{ Instruction::LOG3,		{ "LOG3",			0, 8, 0, true, Tier::Special } },
	{ Instruction::LOG4,		{ "LOG4",			0, 10, 0, true, Tier::Special } },
	{ Instruction::CREATE,		{ "CREATE",			0, 3, 2, true, Tier::Special } },
	{ Instruction::CALL,		{ "CALL",			0, 8, 1, true, Tier::Special } },
	{ Instruction::CALLCODE,	{ "CALLCODE",		0, 8, 1, true, Tier::Special } },
	{ Instruction::RETURN,		{ "RETURN",			0, 2, 0, true, Tier::Zero } },
	{ Instruction::DELEGATECALL,	{ "DELEGATECALL",	0, 7, 1, true, Tier::Special } },
	...
	{ Instruction::SELFDESTRUCT,	{ "SELFDESTRUCT",		0, 2, 0, true, Tier::Special } }
};
